...
<body>
	...
	data-options="singleSelect:true,
	    fitColumns:true,url: '../product/depositReturnLoanList.do',
	    fit:true,
	...
	<div id="dd" class="easyui-dialog" title="账户存管余额" style="height:22%;width:20%"	buttons="btn"
		...
		<div style="padding:5px;height:50">
			存管账户可用余额：<input id="caBalance" class="easyui-textbox" disabled="disabled">元
		</div>
	...
	$.ajax({
		...
		success:function(data){
			if(data.flag){
				...
				//easyui文本输入款会将0转换为null cece
				$("#caBalance").textbox('setValue',data.ca_balance==0?"0.00":data.ca_balance);
				$("#dd").dialog("open");
			}else{
