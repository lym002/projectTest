...
<body>
	...
	<div id="prizeManageTools" style="padding:5px;height:750">
	  	...
	  	发放状态:<select id="commodityStatus" name="commodityStatus" class="easyui-combobox" style="width:150px" data-options="">
							<option value=''>请选择</option>
	...
	function searchJsProductPrize(){
 		$('#drProductPrizeList').datagrid({
 			queryParams: {
 				...
 				commodityStatus:$('#commodityStatus').combobox('getValue'),
