...
<form id="addArticleForm" enctype="multipart/form-data">
	...
	<table >
		<tr>
			...
			<td>
				<input type="text" name="activityDate" style="width:100px;" data-options="required:true" class="easyui-textbox"/>
			</td>
		</tr>
		</table>
		</div>
		...
		<tr>
			<td>		
					...
					<img src="" id="pcPicSrc"  height="160" width="260" /> 
			</td>
			<td>		
					<input type="file" id="appPic" name="appPicFile" onchange="PreviewImage(this)" />
						<div style="color:red;">图片文件最大5MB，支持.jpg.jpeg的图片格式。</div>
					<img src="" id="appPicSrc"  height="160" width="260" /> 
			</td>
		</tr>
		<tr>
			<td align="left" style="vertical-align: top;">
				活动PC链接:<input type="text" name="pcUrl" style="width:200px;" data-options="required:true" class="easyui-textbox"/>
			</td>
			<td align="left" style="vertical-align: top;">
				活动APP链接:<input type="text" name="appUrl" style="width:200px;" data-options="required:true" class="easyui-textbox"/>
			</td>
		</tr>
		<tr>
			<td align="left" style="vertical-align: top;">
			...
			<td align="left"><input id="PC" name="terminalTypePC" type="checkbox" value="1"/>PC</td>
			<td align="left"><input id="H5" name="terminalTypeH5" type="checkbox" value="1"/>H5</td>
			<td align="left"><input id="IOS" name="terminalTypeIOS" type="checkbox" value="1"/>IOS</td>
			<td align="left"><input id="android" name="terminalTypeAndroid" type="checkbox" value="1"/>安卓</td>
		</tr>
	</table>
...
<script type="text/javascript">
	function addArticleBtn(){
		...
		$("#addArticleForm").ajaxSubmit({
            ...
            url: '${apppath}/activity/addAggregationPage.do', // 需要提交的 url
            success: function(result) { // data 保存提交后返回的数据，一般为 json 数据
				...
				if(resultJson.success){
					...
					parent.$('#main-center').tabs('close','添加活动聚合页');
					});
				}else{
