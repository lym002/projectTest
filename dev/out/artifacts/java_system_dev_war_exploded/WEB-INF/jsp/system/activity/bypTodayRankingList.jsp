...
<body>
	<table id="drProductPrizeList" title="5880每日排名" 
	class="easyui-datagrid" style="height:99%;width:99.9%"
	data-options="singleSelect:true,
	    fitColumns:true,url: '../festivaIactivity/todayRankingList.do',
	    fit:true,
	    ...
	    <tr>
	    	...
	    	<th data-options="field:'tjStartTime'"  width="10%"  formatter="formatDateBoxFull">投资时间</th>
