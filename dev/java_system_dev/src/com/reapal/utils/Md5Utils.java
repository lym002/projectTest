...
public class Md5Utils {
     ...
     * @return
     */
    public static boolean vlidateMD5sign(Map<String, String> sArray,String key,String sign) {  
        String vsign = BuildMysign(sArray, key); 
        return sign.equals(vsign) ? true : false;  
    }

    public static boolean validateMD5Sign(String tar, String key, String sign){
		return sign.equals(md5(tar+key, "UTF-8")) ? true : false;
	}
