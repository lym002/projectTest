...
public interface DrChannelInfoDAO {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getDrChannelInfoSum(Map<String, Object> map);

	public List<DrChannelInfo> getAgainChannelInfoOrderList(
			Map<String, Object> map);

	public Integer getAgainChannelInfoOrderListCounts(Map<String, Object> map);

	public List<DrChannelInfo> getFirstDrChannelInfoPhoneList(
			Map<String, Object> map);

	public Integer getFirstDrChannelInfoPhoneListCounts(Map<String, Object> map);

	public List<DrChannelInfo> getAgainChannelInfoPhoneList(
			Map<String, Object> map);

	public Integer getAgainChannelInfoPhoneListCounts(Map<String, Object> map);
