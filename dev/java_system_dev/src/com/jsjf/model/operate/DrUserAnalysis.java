...
public class DrUserAnalysis {
	...
	private Integer notReturnSumUser;//在投用户数
	private BigDecimal avgUserAmount;//用户平均在投额度
	...
	public Integer getNotReturnSumUser() {
		return notReturnSumUser;
	}

	public void setNotReturnSumUser(Integer notReturnSumUser) {
		this.notReturnSumUser = notReturnSumUser;
	}

	public BigDecimal getAvgUserAmount() {
		return avgUserAmount;
	}

	public void setAvgUserAmount(BigDecimal avgUserAmount) {
