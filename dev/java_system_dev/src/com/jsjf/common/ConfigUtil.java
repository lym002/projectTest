...
public class ConfigUtil {
    ...
    public static final String SYS_USER_LOGIN_LOCK = "redisUserLoginLock";
    // 兑换积分锁关键字
    public static final String REDIS_KEY_CONVERT = "Convert.";
    //资产对接
   // public static final String URL = "http://scf-test.heangtec.com/scf-web";//测试
    public static final String URL = "http://scf.heangtec.com/scf-web";//正式
    //public static final String KEY="g0be2385657fa355af68b74e9913a1320af82gb7ae5f580g79bffd04a402ba8f"; //测试
    public static final String KEY="59cf77f1aa25423da037cc3de7d3fb727cb97e50047c49399362b71c5bd30728"; //正式
