...
*/		SAXReader saxReader = new SAXReader();
    ...
    public static void main(String[] args) {
    	JSONObject obj = JSONObject.fromObject("{\"signature\":\"ayVgYejXtLrR0efeKkn3mozPw7VONqbxzlr5WnEfGuMst2YrIHvZPvHxf+nHdWAIMe3WHGppAquf8ERTd0ExGZSCaHWJPPw2X45TXSjCzGk8bLYXWRjYdK+Qwkyh4ORRJylUIIna54LGpGRPoh7Rf6g7fX5TJKzsC/wfEqFDwK4=\",\"message\":{\"login_id\":\"13680000726\",\"amt\":\"100000\",\"resp_code\":\"0000\",\"mchnt_cd\":\"0002900F0353034\",\"mchnt_txn_ssn\":\"20170515093623000180159359\"}}");

    	try {
			verifySignAsynNotice(new FuiouOnlineBankingRspData(obj.getJSONObject("message")), obj.getString("signature"));
		} catch (Exception e) {
