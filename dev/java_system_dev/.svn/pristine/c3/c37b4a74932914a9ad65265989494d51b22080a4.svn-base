	...
	data-options="singleSelect:true,
	    ...
	    <tr>
	        ...
	        <th data-options="field:'addDate'" width="8%"  formatter="formatDateBoxFull">添加时间</th>
	         <th data-options="field:'detail'" width="15%"  >商品简介</th>
	...
	<div id="updateActivityWindow" class="easyui-dialog" title="修改"
		...
		<form id="updateSysProgramForm" enctype="multipart/form-data">
			...
			<input id="id" name="id" readonly="readonly" type="hidden" />
				...
				<tr>
					<td colspan="2" align="left">商品简介：
					<textarea rows="5" cols="50" id="detail" name="detail" style="resize: none"></textarea>
				</tr>
			</table>
		</form>
...
<script type="text/javascript">
	...
	function updatePrize(){
		...
		var formData = new FormData();
	     ...
	     formData.append('detail',$("textarea[name='detail']")[0].value);
	...
	function addRedEnvelope(){
		...
		if(!validate){
	     ...
	     formData.append('detail',$("textarea[name='detail']")[1].value);
