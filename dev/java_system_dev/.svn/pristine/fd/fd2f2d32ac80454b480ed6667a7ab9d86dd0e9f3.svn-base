...
public class MailUtil {  
    ...
    public static String host = "";// 设置邮件服务器,如果不用163的,自己找找看相关的
    public static int smtpPort = 465;//端口号
    public static String sender = "";//发件人
    public static String name = "";//昵称
    public static String username = "";// 登录账号,一般都是和邮箱名一样吧  
    public static String password = "";// 发件人邮箱的登录密码
