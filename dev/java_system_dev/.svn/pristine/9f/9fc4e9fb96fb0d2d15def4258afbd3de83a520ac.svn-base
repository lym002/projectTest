		...
		<div title="<center>企业客户基本信息</center>" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px" data-options="collapsible:true">
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				...
				<tr>
					...
					<td colspan="5">
						<input name="drClaimsCustomer.companyNameProtocolShow" style="width: 655px" type="text" class="easyui-textbox" data-options="validType:'maxLength[100]'"/>
					</td>
				</tr>
				<tr>
					<td align="left">法人姓名：</td>
					<td>
						<input name="drClaimsCustomer.name" type="text" class="easyui-textbox" data-options="required:true,validType:'maxLength[10]'"/>
					</td>
					<td align="left">性别：</td>
					<td>
					...
					<td>
						<input name="drClaimsCustomer.phone" type="text" class="easyui-textbox" data-options="required:true,validType:'maxLength[11]'"/>
					</td>
				</tr>
				<tr>
		...
		<div title="<center>贷款项目基本信息</center>" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px" data-options="collapsible:true">
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				<tr>
					...
					<td>
						<input name="loanUse" type="text" class="easyui-textbox" data-options="required:true,validType:'maxLength[250]'"/>
					</td>
				</tr>
				<tr>
					<td align="left">贷款金额(万元)：</td>
					<td>
						<input name="loanAmount" class="easyui-numberbox" data-options="required:true,min:0,max:100000,precision:6"/>
					</td>
					<td align="left">币种：</td>
					<td>
				...
				<tr>
					...
					<td>
						<input name="loanName" class="easyui-textbox" data-options="validType:'maxLength[100]',required:true"/>
					</td>
					<td align="left">银行名称：</td>
					<td>
						<input name="bankName" class="easyui-textbox" data-options="validType:'maxLength[100]',required:true"/>
					</td>
				</tr>
				<tr>
					<td align="left">银行账号：</td>
					<td colspan="3">
						<input name="bankNo" style="width:450px" type="text" class="easyui-textbox" data-options="validType:'maxLength[50]',required:true"/>
					</td>
					<td align="left">开户行地址：</td>
					<td>
						<input name="bankAddress" class="easyui-textbox" data-options="validType:'maxLength[100]',required:true"/>
					</td>
				</tr>
				<tr>
