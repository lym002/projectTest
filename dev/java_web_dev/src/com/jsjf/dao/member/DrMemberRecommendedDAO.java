...
public interface DrMemberRecommendedDAO {
    ...
    DrMemberRecommended selectByUid(Map<String, Object> properties2);

	int updateByUid(DrMemberRecommended recommended);

    List<Map<String,Object>> getDrMemberTopTen();

	List<Map<String,Object>> getMyRecommended(Integer uid);

	BigDecimal getDrMemberInvestAll(Map<String, Object> param);

	BigDecimal getRewardByReferrerFirstInvest(Integer uid);
}
