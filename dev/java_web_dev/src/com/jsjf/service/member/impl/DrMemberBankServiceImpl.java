...
public class DrMemberBankServiceImpl implements DrMemberBankService {
	...
	@Override
	public BaseResult insertDrMemberBank(Integer uid,String realName,String idCards,String bankNum,String phone)throws Exception{
		...
		sendData.setTerminal_type("03");//app传01  PC传03
		...
		if("S0000000".equals(resultData.getResp_code())){
			...
			map.put("realName","*"+ realName.substring(realName.length()-1,realName.length()));
	...
	public List<SysBank> selectSysBankList() {
		return sysBankDAO.selectSysBankList();
	}

	@Override
	public List<SysBank> selectBank() {
		return sysBankDAO.selectBank();
	}
