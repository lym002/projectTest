...
public class BypMemberIntegral {
	...
	public BypMemberIntegral() {
		super();
	}

	public BypMemberIntegral(Integer id, Integer integralTypeId, Integer uid,BigDecimal amount, Date addtime, Integer isdouble) {
		super();
		this.id = id;
