...
public class DrClaimsLoan{
    ...
    private String businessNo;//企业营业执照编号
    ...
    private Integer recentlyDate;//最近到期
    
    private BigDecimal pendRepayAmount;//待还款金额
    
	private DrClaimsBill drClaimsBill;
	private DrClaimsCustomer drClaimsCustomer;
	private DrClaimsFinanc drClaimsFinanc;
	private DrClaimsGuarantee[] drClaimsGuarantee;
	private DrClaimsShareholder[] drClaimsShareholder;
	private List<DrClaimsPic> DrClaimsPic;
	private String companyNameProtocolShow;//企业名称协议显示
	...
	public Integer getRecentlyDate() {
		return recentlyDate;
	}

	public void setRecentlyDate(Integer recentlyDate) {
