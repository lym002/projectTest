...
public class BypCommodityDetail {
	...
	private Integer type;//奖品类型 1京东卡  2实物
	private String product_url;//奖品照片url
	private BigDecimal need_points;//需要兑换的点数

	private Integer commodityCount;//统计
	

	public BigDecimal getNeed_points() {
		return need_points;
	}

	public void setNeed_points(BigDecimal need_points) {
