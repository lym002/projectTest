...
//	public static String pubKeyUrl = "D:\\cert\\itrus001.cer";
	...
	//重发验证码路径
	public static String rBSms="/fast/sms";
	
	//查询支付状态
	public static String search="/fast/search";
	...
	public static String getrBSms() {
		return rBSms;
	}

	public static void setrBSms(String rBSms) {
		ReapalConfig.rBSms = rBSms;
	}
